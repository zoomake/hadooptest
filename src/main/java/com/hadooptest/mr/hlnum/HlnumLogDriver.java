...
import com.hadooptest.test.TestMaper;
import com.hadooptest.test.TestReducer;
import com.hadooptest.test.WordCountTest;
...
public class HlnumLogDriver {
    public static void main(String[] args) throws IOException, ClassNotFoundException, InterruptedException {
        ...
        Path outputPath= new Path("hdfs://106.14.186.240:8020/hlnumlog/output/");
        ...
        //4.设置作业处理的输入路径
        FileInputFormat.setInputPaths(job,new Path("hdfs://106.14.186.240:8020/hlnumlog/input/"));
        ...
        //7.设置作业的输出路径
        FileOutputFormat.setOutputPath(job,new Path("hdfs://106.14.186.240:8020/hlnumlog/output/"));
        //8.提交结果
